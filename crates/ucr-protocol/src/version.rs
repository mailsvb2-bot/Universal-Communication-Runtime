...
/// Canonical schema version for the public `ucr.v1` runtime envelopes generated by this implementation.
pub const RUNTIME_ENVELOPE_SCHEMA_V1: ProtocolVersion = ProtocolVersion::new(1, 0);

...
pub const IDENTITY_READ_PERMISSION: &str = "ucr.identity.read";
pub const IDENTITY_CREATE_PERMISSION: &str = "ucr.identity.create";
...
pub const LOCAL_TRANSPORT_USE_PERMISSION: &str = "ucr.transport.local.use";

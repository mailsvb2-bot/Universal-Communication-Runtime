...
pub const SERVICE_AUDIT_GROUP_CREATE_OPERATION_KIND: &str = "ucr.group.create";
pub const SERVICE_AUDIT_GROUP_READ_OPERATION_KIND: &str = "ucr.group.read";
pub const SERVICE_AUDIT_GROUP_MEMBERSHIP_READ_OPERATION_KIND: &str = "ucr.group.membership.read";
pub const SERVICE_AUDIT_GROUP_MANAGE_OPERATION_KIND: &str = "ucr.group.manage";
pub const SERVICE_AUDIT_GROUP_MESSAGE_SEND_OPERATION_KIND: &str = "ucr.group.message.send";
pub const SERVICE_AUDIT_GROUP_MESSAGE_READ_OPERATION_KIND: &str = "ucr.group.message.read";
pub const SERVICE_AUDIT_DEVICE_REGISTER_OPERATION_KIND: &str = "ucr.device.register";
pub const SERVICE_AUDIT_DEVICE_READ_OPERATION_KIND: &str = "ucr.device.read";
pub const SERVICE_AUDIT_DEVICE_REVOKE_OPERATION_KIND: &str = "ucr.device.revoke";
pub const SERVICE_AUDIT_SYNC_CREATE_OPERATION_KIND: &str = "ucr.sync.create";
pub const SERVICE_AUDIT_SYNC_READ_OPERATION_KIND: &str = "ucr.sync.read";
...
mod tests {
    ...
    fn resource_quota_policy_requires_service_account_and_valid_resource_limits() {
        ...
        policy.max_concurrent_publishers = Some(0);
        assert_eq!(
            validate_service_resource_quota_policy(&policy),
            Err(ServiceControlValidationError::InvalidQuota)
        );
        policy.max_concurrent_publishers = Some(3);
        policy.max_aggregate_bandwidth_bps = Some(0);
        assert_eq!(
            validate_service_resource_quota_policy(&policy),
            Err(ServiceControlValidationError::InvalidQuota)
        );

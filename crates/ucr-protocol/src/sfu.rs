...
mod tests {
    ...
    const WIRE_V2_SCREEN_SHARE_VECTOR_HEX: &str = "";
    ...
    fn wire_v2_authenticates_explicit_screen_share_source() {
        ...
        assert_eq!(lower_hex(&wire), WIRE_V2_SCREEN_SHARE_VECTOR_HEX);
        assert_eq!(
            decode_sfu_forward_envelope(&wire).expect("decode"),
            expected
        );

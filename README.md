...
<!-- Legacy architecture-test migration marker; obsolete pre-Phase-16 status: **Phase 15 — Internet Transport (Prepared/reference complete; Phase 16 Local Transport not started).** -->

...
An external platform integrates through Service Principal authentication, quotas/audit, permissions, the public Integration API, events, Root Identity/external identity bindings and policies. The implemented Phase-13 ingress exposes canonical SubmitCommand/Identity/Conversation create-read operations without granting raw `AuthorizedDurableRuntime` or storage access.

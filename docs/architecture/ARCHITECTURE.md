...
Phase 0 did not claim those implementations. The current repository now has Prepared Internet/local transports, Call signalling, Audio, Video, Phase-22 direct-call E2EE media protection, Phase-23 Adaptive Media policy, Phase-24 Transport Orchestrator planning, and Phase-25 bounded duplicate-safe Automatic Failover. Conference coordination, bridges, Relay/NAT traversal, discovery, arbitrary direct-message mesh, multipath, federation, SDK language bindings, automatic new-Device MLS admission/rekey policy, and production deployment remain later work; Phase 29 supplies the Prepared standardized MLS group-media/SFU foundation.

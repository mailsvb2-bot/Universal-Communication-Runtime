...
Phase 0 did not claim those implementations. The current repository now has Prepared Internet/local transports, Call signalling, Audio, Video, Phase-22 direct-call E2EE media protection, Phase-23 Adaptive Media policy, and Phase-24 Transport Orchestrator planning/single-primary execution. Cross-provider Automatic Failover, standardized group/SFU key management, conferences, bridges, store-and-forward execution, mesh, federation, SDK language bindings, and production deployment remain later work.

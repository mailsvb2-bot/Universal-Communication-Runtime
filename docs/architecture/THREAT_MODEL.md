...
- end-to-end recovery workflow: concrete authority-verifier providers, credential re-issuance, device-bound credential/content delivery, backup restore conformance, and re-verification transition/UX evidence;

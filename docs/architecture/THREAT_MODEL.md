...
| Malicious service account | External App/API | authenticated principal, least privilege, quotas, audit | credential auth + least-privilege runtime enforced; quotas/audit pending |

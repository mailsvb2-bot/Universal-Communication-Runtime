...
- remaining chaos scenarios: deterministic process-kill fault injection for durable stores, plus network/DNS/Relay/SFU/peer-disappearance/transport-reorder/slow-consumer scenarios when those real boundaries exist;

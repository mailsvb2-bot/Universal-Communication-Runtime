...
- Media renegotiation invalidates stale stream references/generations before another frame is encoded/decoded. Missing negotiation evidence, missing negotiated Audio/Opus capability, codec-parameter mismatch, and unsupported critical extensions in the canonical negotiated result all fail closed.

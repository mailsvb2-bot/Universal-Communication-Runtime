...
The external-consumer SDK surface exposes generated clients for `IntegrationService`, `EventService`, `CallService`, `GroupService`, `DeviceService`, `SyncService`, `StoreForwardService`, `LocalTransportService` and `MeshService`.

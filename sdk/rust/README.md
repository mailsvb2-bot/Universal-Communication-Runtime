...
`UcrSdkClient` wraps the `IntegrationService`, `EventService` and Phase-40 `CallService` RPCs, attaches authentication automatically, and returns canonical generated responses unchanged.

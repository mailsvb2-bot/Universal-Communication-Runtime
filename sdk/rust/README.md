...
`UcrSdkClient` wraps all 19 `IntegrationService`/`EventService` RPCs, attaches authentication automatically, and returns canonical generated responses unchanged.

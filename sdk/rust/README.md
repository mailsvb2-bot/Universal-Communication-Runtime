...
`UcrSdkClient` wraps the `IntegrationService`, `EventService`, `CallService` and Phase-40 `GroupService` RPCs, attaches authentication automatically, and returns canonical generated responses unchanged.

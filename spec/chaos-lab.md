...
The canonical simulation fixture instantiates 100 peers and can apply per-link latency, partitions/merge and peer mobility/network-switch state. It also carries an explicit battery-limit parameter so future energy-aware scenarios can compose without pretending that resource economics are already fully simulated.

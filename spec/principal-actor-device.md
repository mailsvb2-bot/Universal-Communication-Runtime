...
The concrete authentication, permission, quota, and audit schemas are defined in the later permissions/service-account phase. Until then, no consumer receives direct database access or an alternate authorization path.
